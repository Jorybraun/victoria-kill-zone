...
- The **Max Payne** series originated bullet time as a single-player mechanic. **Max Payne 3** does have a “Multi-player” mode and is tagged “Bullet Time,” but the multiplayer version is implemented as a limited **“Bullet Time” Burst** ability that slows the target while the shooter and teammates remain in real time [13, 15]. The original Max Payne and Max Payne 2 are single-player [17, 18].
