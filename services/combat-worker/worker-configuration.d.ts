/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 9c47004ce445c5f859fdade343aadd61)
// Runtime types generated with workerd@1.20260903.1 2026-09-05 nodejs_compat
interface __BaseEnv_Env {
	CONVEX_URL: string;
	COMBAT_TICKET_SECRET: string;
	COMBAT_PROJECTION_SECRET: string;
	COMBAT_ROOMS: DurableObjectNamespace<import("./src/index").CombatRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CombatRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONVEX_URL" | "COMBAT_TICKET_SECRET" | "COMBAT_PROJECTION_SECRET">> {}
}
