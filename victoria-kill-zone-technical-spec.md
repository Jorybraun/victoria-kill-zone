...
8. **Not decided here.** Transform-disagreement tolerance, tracking-quality thresholds, pose cadence, transport, authority relocation, and the contract change that makes a shot's target optional are deferred to KIL-19/20/21/22 and, where they change authority, to ADR 0004. Amendment A1 records no measurement and no anti-cheat claim.
