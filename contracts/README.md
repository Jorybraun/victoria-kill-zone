...
Note: since the matchSnapshot privacy revision, `arena.latitude/longitude` and player `latitude/longitude/headingDegrees/locationAccuracyMeters/locationAt` in the authenticated snapshot cases are no longer emitted; consumers must tolerate their absence.
